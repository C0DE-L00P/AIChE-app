...
public class ViewInternship extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences EventPrefs = getApplicationContext().getSharedPreferences("TrainingChosen", Context.MODE_PRIVATE);
        String TrainingToGet = String.valueOf(EventPrefs.getLong("TrainingToView", 0));


            databaseReference = FirebaseDatabase.getInstance().getReferenceFromUrl("https://fir-app-6fac7.firebaseio.com/").child("Training").child(TrainingToGet);
